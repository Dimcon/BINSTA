...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['coordinate'].columns['gridid'].drop()
    post_meta.tables['coordinate'].columns['grididnum'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['coordinate'].columns['gridid'].create()
    post_meta.tables['coordinate'].columns['grididnum'].drop()
